...
- Opening the app puts the `banshee` command on your PATH, where `/usr/local/bin` takes it. A clean macOS has no such directory, and [one line makes it](docs/install.md#macos-without-homebrew).
